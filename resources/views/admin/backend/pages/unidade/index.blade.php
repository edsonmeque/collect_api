...
<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0"><a href="{{route('unidades.create')}}" class="btn btn-info">
                                   + <i class="align-middle" data-feather="loader"></i> Unidade
                                    </a></h5>
								</div>
								<table class="table table-hover my-0">
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td>
                                                    <a href="{{route('unidades.edit',$unidade->id)}}" class="btn btn-primary"><i class="align-middle" data-feather="edit"></i></a></td>
                                                <td>
